...
class CVSaliency(nn.Module):
    def __init__(self, in_channels=1024, bilinear=False):
        ...
        self.outc = nn.Conv2d(64, 23, kernel_size=1, dtype=torch.complex64)
...
class Up(nn.Module):
    def __init__(self, in_channels, out_channels, bilinear=True):
        ...
        if bilinear:
            ...
            self.up = nn.ConvTranspose2d(in_channels, in_channels // 2, kernel_size=2, stride=2).type(torch.cfloat)
...
class OutConv(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv = nn.Conv2d(in_channels, out_channels, kernel_size=1).type(torch.cfloat)
...
class DoubleConv(nn.Module):
    def __init__(self, in_channels, out_channels, mid_channels=None):
        ...
        self.double_conv = nn.Conv2d(in_channels, mid_channels, kernel_size=3, padding=1, bias=False).type(torch.cfloat)
        self.bn1 = ComplexBatchNorm2d(mid_channels)
        self.double_conv2 = nn.Conv2d(mid_channels, out_channels, kernel_size=3, padding=1, bias=False).type(torch.cfloat)
...
# IMAGE_PATH = 'C:/Users/gadge/Documents/fccns_surge/new/semantic_drone_dataset/semantic_drone_dataset/original_images/'
# MASK_PATH = 'C:/Users/gadge/Documents/fccns_surge/new/semantic_drone_dataset/semantic_drone_dataset/label_images_semantic/'
    ...
    for e in range(epochs):
        ...
        with torch.no_grad():
            ...
            if (test_loss / len(val_loader)) > min_loss:
                ...
                if not_improve == 51:
                    print('Loss not decrease for 51 times, Stop Training')
                    break
