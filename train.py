...
def give_encoder(model):
    ...
    checkpoint = torch.load(r"C:\Users\gadge\Documents\fccns_surge\new\resnet50_best.tar", map_location="cpu")
...
import pickle
geeky_file = open('history', 'wb') 
pickle.dump(history, geeky_file) 
geeky_file.close() 

torch.save(model, 'CVSaliency_full')
